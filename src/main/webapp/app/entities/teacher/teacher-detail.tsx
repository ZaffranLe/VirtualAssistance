...
const mapStateToProps = ({ teacher, document, fullEvaluate, documentType }: IRootState) => ({
...
const mapDispatchToProps = { getEntity, getDocumentEntities, getFullEvaluateEntities, getDocumentTypes };
