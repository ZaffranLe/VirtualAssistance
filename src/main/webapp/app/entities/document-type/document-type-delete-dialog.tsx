...
export class DocumentTypeDeleteDialog extends React.Component<IDocumentTypeDeleteDialogProps> {
  ...
  confirmDelete = event => {
    this.props.deleteEntity(this.props.documentTypeEntity.id);
  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody>
          <Translate contentKey="virtualAssistantApp.documentType.delete.question" interpolate={{ id: documentTypeEntity.id }}>
