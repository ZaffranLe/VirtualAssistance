...
public class FullEvaluateResource {
    ...
    public FullEvaluateResource(FullEvaluateService fullEvaluateService, AnswerService answerService) {
    ...
    @Timed
    public ResponseEntity<FullEvaluate> createFullEvaluate(@RequestBody FullEvaluate fullEvaluate)
    ...
    @Timed
    public ResponseEntity<FullEvaluate> updateFullEvaluate(@RequestBody FullEvaluate fullEvaluate)
            throws URISyntaxException {
    ...
    @Timed
    public ResponseEntity<Void> createEvaluate(@PathVariable(name = "questionresult") String[] questionresult,
            @PathVariable(name = "result") String finalresult) throws URISyntaxException {
    ...
    public ResponseEntity<Void> createEvaluateWithName(@PathVariable(name = "questionresult") String[] questionresult,
            @PathVariable(name = "result") String finalresult, @PathVariable(name = "nameSurvey") String nameSurvey,
    ...
    public ResponseEntity<FullEvaluate> updateEvaluateWithName(
            @PathVariable(name = "idFullEvaluate") String idFullEvaluate,
            @PathVariable(name = "result") String finalresult, @PathVariable(name = "nameSurvey") String nameSurvey,
            @RequestBody List<Answer> answerList) throws URISyntaxException {
        long id = Long.valueOf(idFullEvaluate);
        FullEvaluate fullEvaluate = fullEvaluateService.update(id, finalresult, nameSurvey, answerList);
        // return
